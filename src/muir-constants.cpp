...
const std::string RTI_DECODEDDECODINGDEVICE_PATH("/Decoded/DecodingDevice");
const std::string RTI_DECODEDDECODINGPROCESS_PATH("/Decoded/DecodingProcess");
const std::string RTI_DECODEDDECODINGPROCESSVER_PATH("/Decoded/DecodingProcessVersion");
...
const std::string RTI_DECODEDPROGRAMVER_PATH("/Decoded/ProgramVersion");
